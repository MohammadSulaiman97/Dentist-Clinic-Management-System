...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $chartjsBar = app()->chartjs
            ...
            ->datasets([
                [
                    ...
                    'backgroundColor' => ['#f93a5a', '#f7778c'],
                    'data' => [$nspainvoices2]
                ],
                [
                    "label" => "الفواتير المدفوعة",
                    'backgroundColor' => [ '#029666','#48d6a8'],
                    'data' => [$nspainvoices1]
                ],
                [
        ...
        $chartjsPieChart =  app()->chartjs
            ...
            ->datasets([
                [
                    'backgroundColor' => ['#ff2146', '#029666','#ff9642'],
        ...
        return view('home',compact('chartjsBar','chartjsPieChart'));
    }
}
