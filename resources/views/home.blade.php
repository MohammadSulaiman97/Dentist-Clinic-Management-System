                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7"> عدد اجمالي الفواتير : {{ \App\Models\Invoice::count() }}</p>
                            </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7"> عدد الفواتير المدفوعة جزئيا : {{ \App\Models\Invoice::where('Value_Status', 3)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">
                                                @php
                                                    ...
                                                    $count_invoices3 = \App\Models\Invoice::where('Value_Status', 3)->count();
                                                       if($count_invoices3 == 0){
                                                          ...
                                                          echo round($count_invoices3 = $count_invoices3 / $count_all *100);
                                                          echo '%';
                                                       }
                                                @endphp
                                            </span>
