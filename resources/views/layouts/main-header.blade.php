				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							{{--  --------------   dropdown  logout -----------------------  --}}
							<div class="dropdown main-profile-menu nav nav-item nav-link ml-4">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item mt-2" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="bx bx-log-out"></i>تسجيل خروج</a>
