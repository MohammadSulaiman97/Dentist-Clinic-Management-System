                    ...
                    <div class="card-body">
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>نوع المعالجة</span>
                                    <span>{{ $invoices->type_treatment }}</span></p>
                                <p class="invoice-info-row"><span>تاريخ الاصدار</span>
                                    <span>{{ $invoices->invoice_Date }}</span></p>
                                <p class="invoice-info-row"><span>المريض</span>
                                    <span>{{ $invoices->patient->name }}</span></p>
                            </div>
                        </div>
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                <tr>
                                    <td class="tx-right tx-uppercase tx-bold tx-inverse pr-5">كامل المبلغ</td>
                                    <td class="tx-right">
                                        <h4 class="tx-primary tx-bold">{{ number_format($invoices->Total, 3) }}</h4>
                                    </td>
                                </tr>
